...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
	...
	#ANSWER: it would fail when regexp returns nil, for example: "abbcccddddeeeee"[/zc*/] because z does not match therefore c* can not match pattern.
  end
  ...
  #
  # Why?
  # ANSWER: Because + or * operators are used to match any possible character on input and they would impact significantly performance by a recurrent technique as backtracking.
  ...
  # ANSWER: Character class works only on characters and alternation works on entire regexp, 
  # therefore regexp will be applied in a single step with character classes and alternation uses backtracking to match pattern step by step recurrently. 
