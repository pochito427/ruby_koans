...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
	...
	# ANSWER: 'inject' method executes curly brace blocks operation while iterating over array
    # and recieves an optional parameter which can modify result according to operation 
  end
